...
@section('content')
    ...
    @if($viewMode == 'categories')
        ...
        <div class="grid grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-extrabold text-gray-900">{{ formatBytes($totalSize) }}</div>
                    <div class="text-xs text-gray-400 font-medium">Total Penyimpanan</div>
                </div>
            </div>
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
            ...
            <form method="GET" action="{{ route('files.index') }}" id="filter-form">
                ...
                <div class="flex flex-col lg:flex-row gap-3">
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama berkas..."
    ...
    <script>
        ...
        function emailLinks() {
            ...
            const folder = {{ json_encode($folderName ?? '') }};
        ...
        function emailFolder(clientId, folderName) {
            fetch('{{ route("files.folder-links") }}?client_id=' + clientId + '&folder=' + encodeURIComponent(folderName || ''), {
