        ...
        @if($viewMode == 'files')
            ...
            <script>
                ...
                async function emailLinks() {
                    ...
                    // Icons (Public URLs to ensure visibility in email)
                    ...
                    checked.forEach(cb => {
                        ...
                        // HTML for Email (Table layout handling vertical alignment)
                        htmlContent += `
                    ...
                    if (!confirm('Agar link BISA DIKLIK, sistem akan menyalinnya ke Clipboard.\n\nKlik OK, lalu Paste (Ctrl+V) di Gmail.')) return;
