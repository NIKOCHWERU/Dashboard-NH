    ...
    <div x-data="{ sidebarOpen: false, sidebarCollapsed: false }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            ...
            <div class="h-16 flex items-center justify-between px-4 border-b border-gray-200">
                <div class="flex items-center gap-3 transition-opacity duration-300"
                    ...
                    <img src="/images/logo.png" alt="Logo" class="h-11 w-11 object-contain" onerror="this.src='https://ui-avatars.com/api/?name=NH&background=D4AF37&color=fff'">
                ...
                <div class="transition-opacity duration-300"
                    ...
                    <img src="/images/logo.png" alt="Logo" class="h-10 w-10 object-contain mx-auto" onerror="this.src='https://ui-avatars.com/api/?name=NH&background=D4AF37&color=fff'">
                </div>
                ...
                <ul class="space-y-1 px-2">
                    ...
                    <li>
                        <a href="{{ route('events.index') }}" 
                           ...
                           :class="sidebarCollapsed ? 'justify-center transition-all' : ''">
                            <svg class="w-5 h-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2v12a2 2 0 002 2z"></path></svg>
                    ...
                    <li>
                        <a href="{{ route('profile.edit') }}" 
                           ...
                           :class="sidebarCollapsed ? 'justify-center transition-all' : ''">
                            <svg class="w-5 h-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
            ...
            <div class="p-4 border-t border-gray-200">
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" 
                        ...
                        <svg class="w-5 h-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm h-16 flex justify-between items-center px-6 flex-shrink-0">
                ...
                <button @click="window.innerWidth < 1024 ? sidebarOpen = !sidebarOpen : sidebarCollapsed = !sidebarCollapsed" 
                ...
                <div class="flex items-center ml-auto space-x-4">
                    ...
                    @if(auth()->user()->avatar)
                        <img src="{{ auth()->user()->avatar }}" alt="Avatar" class="h-8 w-8 rounded-full" referrerpolicy="no-referrer">
                    @endif
                </div>
            </header>
